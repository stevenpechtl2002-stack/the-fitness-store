...
export default function Location() {
  ...
  return (
    <section id="standort" className="py-24 lg:py-36 bg-[#141414]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            ...
            {/* Map label */}
            <div className="absolute bottom-4 left-4 z-10 bg-[#1a1a1a]/90 backdrop-blur-sm border border-white/10 px-3 py-2 flex items-center gap-2">
